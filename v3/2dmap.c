...
/*   Updated: 2020/12/01 06:49:05 by abelarif         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move_v(int direction)
{
	...
	(g_player.y + (direction * -1) * sinf(g_player.rotation) * 100000000), 2);
...
void	ft_move_h(int direction)
{
	...
	get_new_position(g_player.x,
		...
		(g_player.y + (direction) * sinf(g_player.rotation + PI / 2) * 100000000), 2);
	// mlx_pixel_put(g_mlx.mlx, g_mlx.win, g_player.x, g_player.y, 0xff0000);
}
